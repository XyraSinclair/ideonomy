# Brief: author one ideonomic map — survival fleet (run 2026-09-07)
...
in the territory of surviving: staying alive in the economy, the psychology of doing so, and status.
...
Written for someone who has to survive: keep a floor under income, keep
their own judgment after being wrong, read and move in a status order they
did not design. Mechanisms, not advice or consolation. Illustrative cases
from real lives and trades — freelancers, founders, immigrants, clergy,
soldiers, nurses, musicians, prisoners, the long-term unemployed, the
newly rich — and the odd remote domain (a wolf pack, a monastery, a ship's
crew) when it sharpens the mechanism. No self-help vocabulary (no "growth",
"mindset", "resilience", "boundaries" as nouns of virtue); no motivational
tone; no diagnosis-speak. Humor and beauty carry exact ideas. Where a
mechanism is contested or speculative, keep its modality visible.
...
- `corpus/fable-maps-2026-09-07-survival/<slug>.json` — the full record, one JSON object, `name` == `<slug>` (kebab-case, no existing list name).
- `corpus/fable-maps-2026-09-07-survival/<slug>.ledger.jsonl` — two lines, one per breath, schema as the exemplar ledger (`t` in ISO-8601 UTC, `by: "fable-fieldwork"`, `reviewed_by: "pending"`). Residue must contain real rejections with reasons; do not manufacture rejections.

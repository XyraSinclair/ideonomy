...
modality visible. Admitted maps that border this fleet, which you must not
restate: negotiator-check-loops, persuasion-moves, ghost-leverages,
leverage-discoveries, deal-flow-sources, deal-flow-reflexivities,
deal-flow-attractors, deal-deaths, clean-exits, what-a-price-does,
tollgates-that-must-buy, who-can-be-bound, status-conversions,
register-jumps, cooperation-ignitions, first-mover-forecloses. Read the ones
nearest your territory in `ideonomy/data/grown.jsonl` and say what each of
your adjacent items adds.
...
- `made_by`: `"fable(deep ideonomy, 2026-09-08)"`. `seriation.named_by`: `"anthropic/claude-fable"`. `via`: `"practice-deep-ideonomy; two Fable fieldwork breaths; independent Fable editorial review"`. `status: "open"`, `parents: []`, `source.tier: "grown"`, `source.kind: "map"`, `coverage: {"universe": "open; no claim of exhaustiveness", "breaths": 2}`, `primitives_exercised` as in the exemplar.

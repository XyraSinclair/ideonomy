# Brief: apply an independent critique to one ideonomic map (run 2026-09-07)
...
1. `corpus/fable-maps-2026-09-07-navigation/BRIEF.md` (standards, schema).
...
- Set `made_by` to `"fable(deep ideonomy; Fable critic admission, 2026-09-07)"`.

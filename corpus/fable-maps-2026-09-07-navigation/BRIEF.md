# Brief: author one ideonomic map — navigation fleet (run 2026-09-07)
...
in the territory of navigation: moving well through many important domains at once (money, law, medicine, family, institutions, craft, markets) and changing register deliberately.
...
Written for someone who must operate across many important domains in one
life — a company, a lawsuit, a diagnosis, a family, a market, a craft — and
who needs to move between registers on purpose: the technical read of a
problem and its political one, the legal frame and the human one, the joke
and the claim. Mechanisms, not advice. Illustrative cases from real lives and
trades, and the odd remote domain when it sharpens the mechanism. No
self-help or consultant vocabulary; no motivational tone. Humor and beauty
carry exact ideas. Where a mechanism is contested or speculative, keep its
modality visible. Maps already admitted today that border this fleet:
runway-illusions, survival-floors, pressure-transmutations,
self-trust-repairs, status-conversions, low-chair-advantages, and the nine
business maps (what-a-price-does, market-births, deal-deaths,
deal-flow-attractors, where-margin-hides, pricing-unit-metamorphoses,
cooperation-ignitions, clean-exits, market-deaths). Do not restate them.
...
- `corpus/fable-maps-2026-09-07-navigation/<slug>.json` — the full record, one JSON object, `name` == `<slug>` (kebab-case, no existing list name).
- `corpus/fable-maps-2026-09-07-navigation/<slug>.ledger.jsonl` — two lines, one per breath, schema as the exemplar ledger (`t` in ISO-8601 UTC, `by: "fable-fieldwork"`, `reviewed_by: "pending"`). Residue must contain real rejections with reasons; do not manufacture rejections.
